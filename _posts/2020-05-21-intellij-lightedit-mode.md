...
In the IntelliJ IDEA update
2020.1 [LightEdit mode was introduced](https://blog.jetbrains.com/idea/2020/04/lightedit-mode/). To set it up on Windows
10 with Jetbrains Toolbox app
